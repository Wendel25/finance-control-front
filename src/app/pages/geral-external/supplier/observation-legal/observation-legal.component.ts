...
@Component({
  selector: 'app-observation-legal',
  standalone: true,
  imports: [
    CommonModule,
    HttpClientModule,
  ...
  templateUrl: './observation-legal.component.html',
  styleUrl: './observation-legal.component.scss'
})
export class ObservationLegalComponent {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<ObservationLegalComponent>,
